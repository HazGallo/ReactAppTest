...
import { ModuleSelectorExampleV2Extra } from './ModuleSelectorExampleV2Extra';

const meta = {
  title: 'Components/ModuleSelector',
  component: ModuleSelectorExampleV2Extra,
  parameters: {
    layout: 'normal',
  },
} satisfies Meta<typeof ModuleSelectorExampleV2Extra>;
...
export const ExtraContentV2: Story = {
  args: {
    dataMenu: arrayTitle,
    isDisabled: false,
